...
if ( ! class_exists( 'QT_Opening_Hours' ) ) {
	class QT_Opening_Hours extends WP_Widget {
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'extra_info' ) ); ?>"><?php esc_html_e( 'Additional Information', 'the-landscaper-wp' ); ?>:</label><br />
				<small><?php esc_html_e( 'For example you could describe: lunchbreaks, holidays or vacantion information', 'the-landscaper-wp' ); ?></small>
