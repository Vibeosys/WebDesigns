...
acf_add_local_field_group(array (
	...
	'fields' => array (
		array (
			...
			'label' => 'Use captions on slides',
			'name' => 'slide_captions',
			'type' => 'true_false',
			'instructions' => 'If checkbox is toggled on you will be able to fill in the captions foreach slide. If checkbox is toggled off no captions will be displayed on the slides.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
		...
		array (
			...
			'sub_fields' => array (
				...
				array (
					'key' => 'field_56e7f24ae75af',
					'label' => 'Link slide',
					'name' => 'link_slide',
					'type' => 'text',
					'instructions' => '(Optional) You can link the slide image to a page URL.',
					'required' => 0,
					'conditional_logic' => array (
						array (
							array (
	...
	'fields' => array (
		array (
			...
			'choices' => array (
				...
				'fullwidth' => 'Fullwidth ( Gallery Fullwidth and Content at the Bottom )',
			),
			'default_value' => array (
				'split' => 'split',
			),
		...
		array (
			'key' => 'field_55b5f7c8965b0',
			'label' => 'Add Textarea',
			'name' => 'add_textarea',
			'type' => 'true_false',
			'instructions' => 'When checked a Wysiwyg editor is added below the gallery images for extra content or to add the before & after images',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		...
		array (
			...
			'type' => 'radio',
			'instructions' => 'Set the page title area to a small or larger height',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
			...
			'other_choice' => 0,
			'save_other_choice' => 0,
			'default_value' => 'header-small',
			'layout' => 'horizontal',
		),
		array (
			'key' => 'field_55c12598baaa0',
			'label' => 'Page Title & Subtitle Align',
		...
		array (
			...
			'type' => 'color_picker',
			'instructions' => 'Change the color of the page title',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '',
...
acf_add_local_field_group(array (
	'key' => 'group_56e8143c645f2',
	'title' => 'Testimonials',
	'fields' => array (
		array (
			'key' => 'field_56e814427aa6e',
